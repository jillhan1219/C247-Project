...
# Newly added
# ============================================================
# Level-3 Model: Level-2 CNN-CTC + SE-Gating (Stable Improvement)
#
# Key ideas:
# - Introduce Squeeze-and-Excitation (SE) blocks for channel-wise attention
# - Use Pre-Activation residual TCN blocks (BN -> GELU -> Conv)
# - Improve training stability and representation capacity
# ============================================================
...
class _SE1D(nn.Module):
    ...
    and generates channel-wise gating weights.
    """
...
class _ResidualTCNBlockV2SE(nn.Module):
    """
    Residual Temporal Convolution Block with SE-Gating.

    Design choices:
    - Pre-activation structure: BatchNorm -> GELU -> Conv
    - Dilated convolutions to enlarge temporal receptive field
    - SE block to adaptively reweight channels
    """
    def __init__(
        self,
        channels: int,
...
class CNNCTCModuleV2_SE(pl.LightningModule):
    """
    CNN-CTC model with SE-enhanced residual TCN backend.

    Compared to Level-2:
    - Keeps BatchNorm and exponential dilation growth
    - Adds SE-gating inside each residual block
    - Uses pre-activation residual design for better stability
    """
    NUM_BANDS: ClassVar[int] = 2
    ELECTRODE_CHANNELS: ClassVar[int] = 16
    ...
    def __init__(
        ...
        # - Rotation-invariant multi-band MLP
        ...
        # Project features to CNN channel dimension
